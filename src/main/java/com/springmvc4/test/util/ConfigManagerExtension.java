...
public final class ConfigManagerExtension {
    ...
    private ConfigManagerExtension(String rootPath, String contextPath, String uri) throws FileNotFoundException, IOException {
    ...
    public static ConfigManagerExtension getInstance(String rootPath, String contextPath, String uri) {
        try {
            return new ConfigManagerExtension(rootPath, contextPath, uri);
...
//    }
    private String getConfigPath () {
        return this.rootPath
                + File.separator + "WEB-INF" +File.separator + "ueditor" + File.separator +"jsp"
                + File.separator + ConfigManagerExtension.configFileName;
    }
